...
class get_user_logs_course extends external_api {
    ...
    public static function execute($courseid, $limit = 20) {
        global $DB;

        self::validate_parameters(self::execute_parameters(), ['courseid' => $courseid, 'limit' => $limit]);
        ...
        $logs = $DB->get_records_sql($sql, ['courseid' => $courseid], 0, $limit);
