...
class Settings(BaseSettings):
    ...
    LTI_ISSUER: str = "http://51.68.124.207/moodle"
    LTI_AUTH_URL: str = "http://51.68.124.207/moodle/mod/lti/auth.php"
    LTI_TOKEN_URL: str = "http://51.68.124.207/moodle/mod/lti/token.php"
    LTI_KEYSET_URL: str = "http://51.68.124.207/moodle/mod/lti/certs.php"
    ...
    # Moodle API
    MOODLE_API_URL: str = "http://51.68.124.207/moodle/webservice/rest/server.php"
    ...
    CORS_ORIGINS: List[str] = [
        "http://localhost:5173",
        "http://localhost:8080",
        "http://51.68.124.207:5173",
        "http://51.68.124.207:8080"
    ]
