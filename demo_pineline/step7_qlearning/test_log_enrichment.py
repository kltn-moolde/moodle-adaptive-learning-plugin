...
def test_course_level_event_enrichment():
    ...
    # Initialize LogPreprocessor with moodle_client
    print("\n3. Initializing LogPreprocessor with enrichment...")
...
def test_module_specific_event():
    ...
    # Initialize LogPreprocessor without moodle_client
    print("\n2. Initializing LogPreprocessor without API...")
    preprocessor = LogPreprocessor(
        course_structure_path="data/course_structure.json",
        recent_window=10,
        excluded_clusters=[3],
...
def main():
    ...
    print("   - LogPreprocessor.enrich_course_level_log() calls Moodle API")
