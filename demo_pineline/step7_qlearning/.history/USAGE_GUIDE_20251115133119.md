...
```json
{
  ...
  "cluster_id": 2,
  "cluster_name": "Medium",
  "state_vector": [2.0, 2.0, 0.75, 1.0, 3.0, 0.0],
  "state_description": {
    "cluster_id": 2,
    "cluster_name": "Medium",
    "module_index": 2,
...
for rec in data["recommendations"]:
    print(f"{rec['priority']}. {rec['module_name']} (Q={rec['q_value']:.2f})")
```
...
def get_recommendations_for_student(student_data):
    ...
    payload = {
        ...
        "features": {
            ...
            "is_stuck": student_data['is_stuck']
        },
        "top_k": 5
    }
...
recommendations = get_recommendations_for_student(student)
for rec in recommendations['recommendations']:
    print(f"→ {rec['module_name']} (Q={rec['q_value']:.2f})")
```
