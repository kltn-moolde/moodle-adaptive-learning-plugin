%% FJCAI2026 Format - Converted from paper.tex
%% Original content preserved, only formatting changed
...
\fancyhead[L]{\centering{\small{\textit{Hội thảo khoa học Quốc gia về Trí tuệ nhân tạo 2026 (FJCAI) - Cần Thơ, 27-28/3/2026}}}}

\title{Adaptive STEM Learning Pathway Optimisation via Reinforcement Learning}

\author{\IEEEauthorblockN{Nhu-Tai Do\IEEEauthorrefmark{1}, Nguyen Huu Loc\IEEEauthorrefmark{1}, Van Tuan Kiet\IEEEauthorrefmark{1}, Nguyen Thi Ngoc Thanh\IEEEauthorrefmark{2}}
	\IEEEauthorblockA{\IEEEauthorrefmark{1}Dept. of Information Technology, Saigon University, Ho Chi Minh City, Vietnam}
	\IEEEauthorblockA{\IEEEauthorrefmark{2}Dept. of Information Technology, Ho Chi Minh City Open University, Vietnam}
	\IEEEauthorblockA{Email: dntai@sgu.edu.vn, lockbkbang@gmail.com, vankiet27012004@gmail.com, thanh.ntn@ou.edu.vn}
}
...
The system is designed as an external LTI Tool that interacts with Moodle through the LTI~1.3 security framework, enabling the AI agent to operate as an independent intelligent layer that fetches learner logs and synchronizes optimized pathways without compromising the core LMS's integrity.
...
\end{equation}
Here, cluster-adaptive $R_{base}$ personalizes motivation, $R_{LO}$ tracks actual mastery gains, process-driven $R_{bonus}$ reinforces valid pedagogical sequences, and adaptive $P_{penalty}$ minimizes inefficiency
...
Experimental results indicate that the learned Q-table occupies approximately 219~KB of memory. Within the theoretical state space of 4,320 states, the agent actively explored and optimized 809 core states, which correspond to the most frequently encountered and pedagogically relevant learning scenarios. Rare or infrequent states were effectively handled through the generalization capability induced by the $\epsilon$-greedy exploration strategy during the early training phase.
...
To interpret the learned policy, SHAP values were computed over 809 representative states extracted from the optimized Q-table. For each state feature, two complementary importance indicators were calculated:
\begin{itemize}
...
\caption{Distribution of SHAP values across 809 core states. Each point represents a state; color denotes feature magnitude (red = high, blue = low), while the horizontal axis indicates the direction and strength of influence on the Q-value.}
...
\begin{table}[t]
\caption{Feature importance ranking based on SHAP analysis over 809 core states}
...
C.~B.~Frey and M.~A.~Osborne, ``The future of employment: How susceptible are jobs to computerisation?,'' \textit{Technological forecasting and social change}, vol.~114, pp.~254--280, 2017.

\bibitem{capuano2020adaptive}
N.~Capuano and S.~Caball\'e, ``Adaptive learning technologies,'' \textit{Ai Magazine}, vol.~41, no.~2, pp.~96--98, 2020.

\bibitem{thuan2022ung}
T.~B.~Thuấn, ``Ứng dụng Machine Learning dự báo sinh viên diện cảnh báo học tập tại Trường Đại học Kinh tế Huế,'' \textit{Tạp chí Khoa học Quản lý và Kinh tế}, no.~21, 2022.

\bibitem{sang2020du}
L.~H.~Sang, N.~T.~Hải, T.~T.~Điện, and N.~T.~Nghe, ``Dự báo kết quả học tập bằng kỹ thuật học sâu với mạng nơ-ron đa tầng,'' \textit{Tạp chí Khoa học Đại học Cần Thơ}, vol.~56, no.~3, pp.~20--28, 2020.

\bibitem{sutton1998reinforcement}
R.~S.~Sutton and A.~G.~Barto, \textit{Reinforcement learning: An introduction}. MIT press, 1998.

\bibitem{chi2014icap}
M.~T.~H.~Chi and R.~Wylie, ``The ICAP framework: Linking cognitive engagement to active learning outcomes,'' \textit{Educational psychologist}, vol.~49, no.~4, pp.~219--243, 2014.

\bibitem{gligorea2023adaptive}
I.~Gligorea, M.~Cioca, R.~Oancea, A.-T.~Gorski, H.~Gorski, and P.~Tudorache, ``Adaptive learning using artificial intelligence in e-learning: A literature review,'' \textit{Education Sciences}, vol.~13, no.~12, p.~1216, 2023.
...
\bibitem{dataset_kaggle}
M.~Sneiders, ``Moodle Log \& Grades Dataset,'' Kaggle, 2021. [Online]. Available: https://www.kaggle.com/datasets/martinssneiders/moodle-grades-and-action-logs

\bibitem{mnih2015human}
V.~Mnih, K.~Kavukcuoglu, D.~Silver, \textit{et al.}, ``Human-level control through deep reinforcement learning,'' \textit{Nature}, vol.~518, no.~7540, pp.~529--533, 2015.
